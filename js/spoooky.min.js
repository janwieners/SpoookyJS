...
m,n;b=null;var t=[],p,r,q,v,u=d.getGame();p=a?a:d.getMoves();m=d.position.x;n=d.position.y;if(!1===u.models.DiceBox.isEnabled){for(q=k;q--;)a=d.getGoal(q),!0===d.executeGoalByName(a.name)&&(b=d.translateDirection(a.move),c=parseInt(m+b[0],10),e=parseInt(n+b[1],10),b=u.getUniqueMoveID(d.name,a.name,c,e),t.push({ID:b,type:a.type,entity:d,name:a.name,preArrangeX:parseInt(m,10),preArrangeY:parseInt(n,10),targetX:c,targetY:e,moveClass:"move_goal"}));for(v=a=p.length;v--;)if(r=p[v],1<r.freq){u.doVirtualMove(d.position.x,
d.position.y,r.targetX,r.targetY);m=r.targetX;n=r.targetY;for(q=k;q--;)a=d.getGoal(q),a.move===r.name&&!0===d.executeGoalByName(a.name)&&(b=d.translateDirection(a.move),c=parseInt(m+b[0],10),e=parseInt(n+b[1],10),b=u.getUniqueMoveID(d.name,a.name,c,e),t.push({ID:b,type:a.type,entity:d,name:a.name,preArrangeX:parseInt(m,10),preArrangeY:parseInt(n,10),targetX:c,targetY:e,moveClass:"move_goal"}));u.undoVirtualMove()}}else for(p=u.getDiceBox().getDiceValues(),a=p.length,c=0,m=d.getWorld().getFieldID(m,
n),!1===_.isUndefined(d.tmp.fieldID)&&(m=d.tmp.fieldID),n=a;n--;)for(q=k;q--;)a=d.getGoal(q),!0===d.executeGoalByName(a.name,p[n])&&("BEAR OFF MOVE"===a.move?(r=a.area,b=u.getUniqueMoveID(d.name,a.name,r,"bearoff"),u.setMoveID(b),u.getDiceBox().connectMoveIDWithDiceValue(b,n,r),t.push({ID:b,type:"DICE",entity:d,name:a.name,diceID:n,diceValue:p[n],targetArea:r,moveClass:"move_bearoff"}),u.getArea(r).moveID=u.models.moveID):("MOVE POSITIVE"===a.move?c=parseInt(m+p[n],10):"MOVE NEGATIVE"===a.move&&(c=
parseInt(m-p[n],10)),r=d.getWorld().getContentOfFieldsWithFieldID(c),b=_.first(r),0===b&&(b=_.last(r)),r={x:b.position.x,y:b.position.y},b=u.getUniqueMoveID(d.name,a.name,r.x,r.y),u.setMoveID(b),u.getDiceBox().connectMoveIDWithDiceValue(b,n,r),t.push({ID:b,name:a.name,entity:d,type:"DICE",diceValue:p[n],diceID:n,targetX:parseInt(r.x,10),targetY:parseInt(r.y,10),moveClass:"move_goal"})));return t};d.canBeCaptured=function(){for(var a=d.getAssociatedPlayer().getNextOpponentPlayer(),b=a.countEntities(),
