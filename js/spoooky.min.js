...
c&&(f.cellID=g,g++)};a.setFieldIDs=function(c){var e,d,f=0,g=a.getColumns(),h=a.getRows(),l=b.models.GameGrid;for(d=0;d<h;d+=1)for(e=0;e<g;e+=1)l[d][e].cellID=c[f],f+=1;return!0};a.getFieldID=function(c,e){return a.isValidCoordinate(c,e)?b.models.GameGrid[e][c].cellID:!1};a.connectCells=function(a){b.models.CellConnections=a};a.createBoardSignature=function(){for(var a=b.models.GameGrid,e=b.gameWorld.getColumns(),d="",f=_.flatten(a),g=f.length,h,a=0;a<g;a++)h=f[a].contains,d=0===h.length?d+"0":d+
...
a.getArea(c).moveID};a.incrementElements=function(c){a.getArea(c).elementCounter++};a.getMoveID=function(c){return a.getArea(c).moveID};a.addArea=function(c){a.enable();b.models.Areas.content.push({name:c,moveID:0,display:"",elementCounter:0})};a.getArea=function(a){return _.find(b.models.Areas.content,function(e){return e.name===a})};a.resetDisplays=function(){_.each(b.models.Areas.content,function(a){a.display=""})}};Spoooky.Agent=function(b,a){var c=this;c.ID=a;c.metaAgentID=b;c.role="ANALYZE POSSIBLE MOVES";
c.focus="ALL";c.fitness=1;c.thinkingTime=1E4;c.maximumSteps=1E4;c.uctConstant=.9;c.proposeBestMove=function(){var a=!1,d=c.ID,b=c.role,g=c.focus,h=c.maximumSteps,l=c.createBrain(),k=c.uctConstant,m=c.thinkingTime,n=Spoooky.AI.game.getPlayerWithID(c.metaAgentID).learningEnabled;localStorage["#mctsgraph"]&&(a=!0);switch(b){case "ANALYZE POSSIBLE MOVES":l.postMessage({agentID:d,agentRole:b,agentFocus:g,maxSteps:h,maxTime:m,learn:n,uctConstant:k,command:"monte carlo tree search with uct",gameModel:Spoooky.AI.game.stringifyModels(),
generateMctsGraph:a});break;case "SEARCH FOR IMMEDIATE THREATS":l.postMessage({agentID:d,agentRole:b,agentFocus:g,command:"alpha beta negamax",maxDepth:3,gameModel:Spoooky.AI.game.stringifyModels()});break;default:console.log("Unknown Agent Role.")}};c.createBrain=function(){var a=new Worker("../../js/spoooky.Worker.min.js"),d=Spoooky.AI.game.getPlayerWithID(c.metaAgentID);a.addEventListener("message",function(a){switch(a.data.type){case "decision":d.coordinateAgentDecisions(a.data);break;case "random":d.coordinateAgentDecisions(a.data)}});
return a}};Spoooky.MetaAgent=function(b){var a=this;a.name="";a.setName=function(c){a.name=c};a.getName=function(){return a.name};a.getGame=function(){return b};a.ID=0;a.getID=function(){return a.ID};a.setID=function(c){a.ID=c};a.type="HUMAN";a.setType=function(c){if("HUMAN"===c||"ARTIFICIAL"===c)return a.type=c,!0;console.log("Invalid Player Type. Allowed Player Types: HUMAN or ARTIFICIAL");return!1};a.learningEnabled=!1;a.enableLearning=function(){a.learningEnabled=!0};a.QLearner={};a.gameHasEnded=
function(){if(a.learningEnabled){Spoooky.GameProcess.pushMessage("Meta Agent "+a.ID+" lernt...");a.QLearner.learn(1E4);var c;c="{\n"+('\t"game" : "'+a.getGame().getName()+'",\n');c+='\t"metaAgentID" : '+a.ID+",\n";c=c+'\t"bestAgentEnsemble" : '+JSON.stringify(a.agents,null,"\t");c+=",\n";c+='\t"learnModule" : ';c+=JSON.stringify(a.QLearner,null,"\t");c+="\n}";c=new Blob([c],{type:"text/plain;charset=utf-8"});saveAs(c,"agentmemory_"+a.ID+".json")}};a.associateEntity=function(c,e){c.associatedWithMetaAgent=
a.ID;"PLACE"===c.mode&&a.getGame().addEntityToGame(c,e)};a.entityFactory=function(c){var e;e="";var d=0;e=c.entityName?c.entityName:a.ID+"_entity_"+parseInt(a.countEntities()+1,10);d=c.entityID?c.entityID:parseInt(a.countEntities()+1,10);e=new Spoooky.Entity(e,d,c.typeID,a.getGame());e.setType(c.entityType);e.setRepresentation(c.representation.type,c.representation.texture);var b,g=c.moves;if(g)for(d=0;d<g.length;d++)b=g[d],e.addMove({name:b.name,type:b.type,direction:b.direction,frequency:b.frequency,
conditions:b.conditions,postMove:b.postMove});if(c.goalAtoms)for(d=0;d<c.goalAtoms.length;d++)b=c.goalAtoms[d],e.addGoalAtom(b.atomName,b.atomFunction,b.atomArguments);if(c.goals)for(d=0;d<c.goals.length;d++)b=c.goals[d],e.assembleGoal({type:b.type,name:b.name,atoms:b.atoms,move:b.move,area:b.area});e.selectCondition=c.selectCondition;e.postMoveCheck=c.postMoveCheck?c.postMoveCheck:null;e.setGoalTargets(c.goalTargets);c.unlimitedQuantity&&(e.unlimitedQuantity=!0);c.mode&&(e.mode=c.mode);c.placeTo&&
...
a.QLearner=new Spoooky.QLearner;a.QLearner.reward=c.learnModule.rewards;a.QLearner.gameStates=c.learnModule.gameStates;$.each(c.bestAgentEnsemble,function(c,b){a.assembleAgent(b.ID,b.role,b.focus,b.maximumSteps,b.thinkingTime,b.fitness,b.uctConstant)})},complete:function(){if(b){Spoooky.AgentLog.messages.pop();var d=_.keys(a.QLearner.gameStates).length;Spoooky.AgentLog.pushMessage(d+" gelernte Spielzustaende wurden erfolgreich aus der Datei "+c+" geladen.")}},error:function(){0===a.agents.length&&
...
a);return!_.isEmpty(a)};d.getMoves=function(){var a=d.countPossibleMoves();if(0>=a)return!1;for(var b,c,e,k,m,n,p,t=[],q=d.getGame(),v=a;v--;)switch(a=d.getMove(v),a.type){case "Default":if(0<a.frequency||"ANY"===a.frequency)for(c=a.frequency,e=d.position.x,k=d.position.y,"ANY"===c&&(c=23),m=1;m<=c;m+=1){n=e+a.xDirection*m;p=k+a.yDirection*m;if(!1===d.getWorld().isEmpty(n,p))break;q.isLegalMove(d,a.conditions,e,k,n,p)&&(b=q.getUniqueMoveID(d.name,a.name,n,p),t.push({type:"MOVE",name:a.name,entity:d,
targetX:n,targetY:p,moveClass:"move_standard",freq:c,ID:b,postMove:a.postMove}),q.addJobForMoveID({jobID:b,jobName:"move game entity",job:"Move Entity",jobArguments:{entity:d,destX:n,destY:p}}),a.postMove&&_.each(a.postMove,function(a){q.addJobForMoveID({jobID:b,jobName:a.jobName,job:a.jobFunction,jobArguments:a.jobArguments})}))}break;case "By Connected Field IDs":n=q.models.CellConnections;e=d.position.x;k=d.position.y;m=n[q.models.GameGrid[k][e].cellID];for(var u=m.length;u--;){p=d.getWorld().getFieldsWithFieldID(m[u],
!0);n=p.position.x;p=p.position.y;if(!1===d.getWorld().isEmpty(n,p))break;q.isLegalMove(d,a.conditions,e,k,n,p)&&(b=q.getUniqueMoveID(d.name,a.name,n,p),t.push({type:"MOVE",name:a.name,entity:d,targetX:n,targetY:p,moveClass:"move_standard",freq:c,ID:b,postMove:a.postMove}),q.addJobForMoveID({jobID:b,jobName:"move game entity",job:"Move Entity",jobArguments:{entity:d,destX:n,destY:p}}),a.postMove&&_.each(a.postMove,function(a){q.addJobForMoveID({jobID:b,jobName:a.jobName,job:a.jobFunction,jobArguments:a.jobArguments})}))}break;
case "By Field ID":if("DICE"===a.frequency){m=q.getDiceBox().getDiceValues();n=m.length;p=[];u=0;e=-1;var r=!1;e=d.position.x;k=d.position.y;!1===_.isUndefined(d.tmp.fieldID)?(e=d.tmp.fieldID,r=!0):e=d.getWorld().getFieldID(e,k);for(k=n;k--;)"POSITIVE"===a.direction[1]?u=parseInt(e+m[k],10):"NEGATIVE"===a.direction[1]&&(u=parseInt(e-m[k],10)),"By Field ID"===a.type&&0===d.countOpponentsOnFieldsWithID(u,d)&&(p=d.getWorld().getFreeFieldsWithFieldID(u),p[0]?(n=p[0][0],p=12>=u?p[parseInt(p.length-1,10)][1]:
p[0][1],b=q.getUniqueMoveID(d.name,a.name,n,p),t.push({type:"DICE",diceID:k,diceValue:m[k],name:a.name,entity:d,targetX:n,targetY:p,moveClass:"move_standard",freq:"DICE",ID:b,postmove:a.postMove}),!0===r?(q.addJobForMoveID({jobID:b,jobName:"Put the entity to the destination field",job:"Place Entity",jobArguments:{entity:d,xPosition:n,yPosition:p}}),q.addJobForMoveID({jobID:b,jobName:"Remove the current entity from off board area",job:"Delete Entity from OffBoard",jobArguments:{entity:d}})):q.addJobForMoveID({jobID:b,
jobName:"move game entity",job:"Move Entity",jobArguments:{entity:d,destX:n,destY:p}}),q.addJobForMoveID({jobID:b,jobName:"Delete Dice Value",job:"Delete Dice Value",jobArguments:k}),a.postMove&&_.each(a.postMove,function(a){q.addJobForMoveID({jobID:b,jobName:a.jobName,job:a.jobFunction,jobArguments:a.jobArguments})})):d.countOwnOnFieldsWithID(u,d)===d.countFieldsWithID(u)&&(p=d.getWorld().getFieldsWithFieldID(u),p[0]&&(n=p[0].position.x,p=12>=u?p[0].position.y:p[parseInt(p.length-1,10)].position.y,
b=q.getUniqueMoveID(d.name,a.name,n,p),t.push({type:"DICE",diceValue:m[k],name:a.name,entity:d,targetX:n,targetY:p,moveClass:"move_standard",freq:"DICE",ID:b,postmove:a.postMove}),q.addJobForMoveID({jobID:b,jobName:"move game entity",job:"Move Entity",jobArguments:{entity:d,destX:n,destY:p}}),q.addJobForMoveID({jobID:b,jobName:"Delete Dice Value",job:"Delete Dice Value",jobArguments:k}),a.postMove&&_.each(a.postMove,function(a){q.addJobForMoveID({jobID:b,jobName:a.jobName,job:a.jobFunction,jobArguments:a.jobArguments})}))))}}return t};
...
k;v--;)a=d.getGoal(v),!0===d.executeGoalByName(a.name)&&(b=d.translateDirection(a.move),c=parseInt(m+b[0],10),e=parseInt(n+b[1],10),b=r.getUniqueMoveID(d.name,a.name,c,e),p.push({ID:b,type:a.type,entity:d,name:a.name,preArrangeX:parseInt(m,10),preArrangeY:parseInt(n,10),targetX:c,targetY:e,moveClass:"move_goal"}));for(u=a=t.length;u--;)if(q=t[u],1<q.freq){r.doVirtualMove(d.position.x,d.position.y,q.targetX,q.targetY);m=q.targetX;n=q.targetY;for(v=k;v--;)a=d.getGoal(v),a.move===q.name&&!0===d.executeGoalByName(a.name)&&
(b=d.translateDirection(a.move),c=parseInt(m+b[0],10),e=parseInt(n+b[1],10),b=r.getUniqueMoveID(d.name,a.name,c,e),p.push({ID:b,type:a.type,entity:d,name:a.name,preArrangeX:parseInt(m,10),preArrangeY:parseInt(n,10),targetX:c,targetY:e,moveClass:"move_goal"}));r.undoVirtualMove()}}else for(t=r.getDiceBox().getDiceValues(),a=t.length,c=0,m=d.getWorld().getFieldID(m,n),!1===_.isUndefined(d.tmp.fieldID)&&(m=d.tmp.fieldID),n=a;n--;)for(v=k;v--;)a=d.getGoal(v),!0===d.executeGoalByName(a.name,t[n])&&("BEAR OFF MOVE"===
a.move?(q=a.area,b=r.getUniqueMoveID(d.name,a.name,q,"bearoff"),r.setMoveID(b),r.getDiceBox().connectMoveIDWithDiceValue(b,n,q),p.push({ID:b,type:"DICE",entity:d,name:a.name,diceID:n,diceValue:t[n],targetArea:q,moveClass:"move_bearoff"}),r.getArea(q).moveID=r.models.moveID):("MOVE POSITIVE"===a.move?c=parseInt(m+t[n],10):"MOVE NEGATIVE"===a.move&&(c=parseInt(m-t[n],10)),q=d.getWorld().getContentOfFieldsWithFieldID(c),b=_.first(q),0===b&&(b=_.last(q)),q={x:b.position.x,y:b.position.y},b=r.getUniqueMoveID(d.name,
a.name,q.x,q.y),r.setMoveID(b),r.getDiceBox().connectMoveIDWithDiceValue(b,n,q),p.push({ID:b,name:a.name,entity:d,type:"DICE",diceValue:t[n],diceID:n,targetX:parseInt(q.x,10),targetY:parseInt(q.y,10),moveClass:"move_goal"})));return p};d.canBeCaptured=function(){for(var a=d.getAssociatedPlayer().getNextOpponentPlayer(),b=a.countEntities(),a=a.getEntities();b--;)if(!0===a[b].canCaptureAt(d.position.x,d.position.y))return!0;return!1};d.goals=[];d.assembleGoal=function(a){d.goals.push(a)};d.getGoal=
