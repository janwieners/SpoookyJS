...
k&&(e=Spoooky.AI.createMCTSGraph(l,a));return{mctsGraph:e,simCount:n,simSteps:u,results:b,QLearner:t}},createMCTSGraph:function(a,b){var e={ID:"Root",children:[],parent:"null",value:a.visits,name:"Entscheidungsknoten (Spieler ID "+a.playerToMove+", "+a.getWinRate().toFixed(3)+" / "+a.visits+")"},d=[];try{Spoooky.AI.preProcessChildNodes(a.childNodes,b,d)}catch(c){d.length=0}try{e.children=Spoooky.AI.createTree(d,"Root",0,10)}catch(l){e.children.length=0}return e},preProcessChildNodes:function(a,b,
